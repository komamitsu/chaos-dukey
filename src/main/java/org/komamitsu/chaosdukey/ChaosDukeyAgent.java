...
public class ChaosDukeyAgent {
    ...
    ChaosDukeyAgent(ElementMatcher<TypeDefinition> typeMatcher,
    ...
    public static void premain(String arguments,
        ...
        ChaosDukeyInterceptor interceptor = new ChaosDukeyInterceptor(agent.percentage, agent.maxDelayMillis);
